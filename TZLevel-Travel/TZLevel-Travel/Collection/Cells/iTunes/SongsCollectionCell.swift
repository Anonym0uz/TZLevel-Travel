...
class SongsCollectionCell: UICollectionViewCell {
    ...
    let cellTitle: UILabel = {
        let lbl = UILabel().setupLabel(text: "Songs", textColor: UIColor.black, parentView: nil)
        return lbl
    }()
    ...
    func createViewElements() {
        ...
        cellCollectionView.register(ChildSongsCollectionCell.self, forCellWithReuseIdentifier: cellID)
...
extension SongsCollectionCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell: ChildSongsCollectionCell = collectionView.dequeueReusableCell(withReuseIdentifier: cellID, for: indexPath) as! ChildSongsCollectionCell
