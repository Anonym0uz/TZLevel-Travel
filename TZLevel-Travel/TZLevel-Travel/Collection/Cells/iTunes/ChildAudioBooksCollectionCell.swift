//
//  ChildAudioBooksCollectionCell.swift
//  TZLevel-Travel
//
...
protocol ChildAudioBooksCellDelegate {
    func updateCell(model: iTunesObject)
}

class ChildAudioBooksCollectionCell: UICollectionViewCell, ChildAudioBooksCellDelegate {
    
    var delegate: ChildAudioBooksCellDelegate?
    
    func updateCell(model: iTunesObject) {
        self.cellImage.image = nil
        self.cellTitle.text = model.collectionName
